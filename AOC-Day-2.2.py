...
def passchecker(code):
    ...
    if letcount[int(numrange[0])-1] == letter[0] and letcount[int(numrange[1])- 1] != letter[0]:
        return True
    elif letcount[int(numrange[1])- 1] == letter[0] and letcount[int(numrange[0])-1] != letter[0]:
        return True
    else:
        return False
